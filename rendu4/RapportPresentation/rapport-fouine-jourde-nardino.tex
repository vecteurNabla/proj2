...
Comme dit plus haut, \fouine\ est programmé principalement en
...
\item[stdLib.ml] Des fonctions tout plein (en particulier, nos
  opérateurs infixes)
\item[transformation.ml] Gère la transformation CPS des programmes en
  entrée
\item[reduction.ml] Aide le fichier précédent dans sa quête
...
\newpage
\begin{center}
{\Huge \bsc{Tchana2025}~\cite{Tchana21}}
\end{center}
